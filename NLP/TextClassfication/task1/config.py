...
def get_args():
    ...
    parser.add_argument("--config-dir",type=str,default="./config",help="configure data path.")
    ...
    parser.add_argument("--test-batch-size",type=int,default=1024,help="the test batch size of the dataset.")
    ...
    parser.add_argument("--epoch-times",type=int,default=30,help="the training times of the model.")
